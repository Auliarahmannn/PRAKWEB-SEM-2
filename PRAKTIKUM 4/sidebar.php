...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="dist/img/Link-Baca-Manga-Jujutsu-Kaisen-Chapter-220-Sub-Indo-3115064104.webp" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="#" class="d-block">Aulia Rahman Pakpahan</a>
            </div>
        </div>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="nilai_siswa.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nilai Siswa</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="hasil_nilai.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Hasil Nilai</p>
                                    </a>
                                </li>
